...
This will create an executable jar file **demo.mp-thorntail.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/demo.mp-thorntail.jar
